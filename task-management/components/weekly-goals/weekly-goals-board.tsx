            ...
            <>
              ...
              <div className="flex justify-end gap-2">
                <button
                  type="button"
                  onClick={onClose}
                  className={`rounded-pill bg-surface-card px-4 py-2.5 text-[14px] font-semibold text-ink-soft hover:text-ink-strong transition-colors ${FOCUS_RING}`}
                >
                  Cancel
                </button>
                <button
            ...
            <>
              ...
              <div className="flex justify-between gap-2">
                <button
                  ...
                  onClick={() => setStep(1)}
                  disabled={pending}
                  className={`rounded-pill bg-surface-card px-4 py-2.5 text-[14px] font-semibold text-ink-soft hover:text-ink-strong transition-colors disabled:opacity-50 ${FOCUS_RING}`}
                >
                  ← Back
                </button>
                <button
