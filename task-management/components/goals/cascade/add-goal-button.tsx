      ...
      <button
        ...
        className={
          variant === "solid"
            ...
            : "brand-btn wg-btn inline-flex items-center gap-1.5 rounded-full border border-dashed border-hairline-strong bg-surface-card px-4 py-2 text-[13.5px] font-bold text-ink-soft transition-colors hover:text-ink-strong"
        }
